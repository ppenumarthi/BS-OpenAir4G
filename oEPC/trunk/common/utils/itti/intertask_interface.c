...
//#if defined(OAI_EMU) || defined(RTAI) --NFVEPC Specific Modification
#if defined(RTAI)
...
//#if defined(OAI_EMU) || defined(RTAI) -- NFVEPC Specific Modification
        ...
        //memory_pools_set_info (itti_desc.memory_pools_handle, message, 1, destination_task_id); // Added by nfvepc
...
//#if defined(OAI_EMU) || defined(RTAI)-- NFVEPC Specific Modification
    ...
    itti_desc.memory_pools_handle = memory_pools_create (15);
